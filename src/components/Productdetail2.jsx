...
//     boxShadow: "0 6px 20px rgba(3,7,18,0.14), 0 0 20px rgba(12,34,86,0.06)",
...
//    @keyframes neonPulse {
//   from {
//     text-shadow: 0 0 5px rgba(11, 11, 11, 0.5), 0 0 5px rgba(23, 23, 23, 0.3), 0 0 30px rgba(239, 58, 58, 0.2);
//     opacity: 0.8;
//   }
//   to {
//     text-shadow: 0 0 5px rgba(20, 15, 15, 0.8), 0 0 10px rgba(14, 1, 1, 0.5), 0 0 40px rgba(239, 58, 58, 0.3);
//     opacity: 1;
//   }
// }
//         `}
...
//   {hasSubtypes && <col style={{ width: "14%" }} />}
  
//   <col style={{ width: hasSubtypes ? "16%" : "20%" }} />
 
//   {dimensionColumns.map((_, i) => (
//     <col key={`dim-${i}`} style={{ width: hasSubtypes ? "7%" : "8%" }} />
//   ))}
...
//         <thead>
//           <tr>
//             <th rowSpan="2" style={{...getCellStyle(thBaseStyle, 0),fontWeight: 700}}>
//               {product.title}
//             </th>
//             {hasSubtypes && (
//               <th rowSpan="2" style={{...getCellStyle(thBaseStyle, 1),fontWeight: 700}}>
//                 Subtype
//               </th>
//             )}
//             <th rowSpan="2" style={{...getCellStyle(thBaseStyle, hasSubtypes ? 2 : 1),fontWeight: 700}}>
//               Model
//             </th>
//             <th
//               colSpan={dimensionColumns.length}
...
//           /* Critical: Prevent any inner container from creating its own scroll */
//           main {
//             flex: 1;
//             width: 100%;
//             max-width: 100vw;
...
//           /* Ensure centered content doesn't trigger inner scroll */
//           main > div {
//             width: 100%;
//             max-width: 1300px;
//             margin: 0 auto;
...
//           >
//             <div style={navButtonWrapperStyle}>
//               <button onClick={() => handleNavClick("product")} aria-current={activeSection === "product" ? "page" : undefined} className="nav-tab" style={{ marginRight: "10px", borderRadius: "6px 6px 0 0" }}>
//                 PRODUCTS
//               </button>
//               <button onClick={() => handleNavClick("technical")} aria-current={activeSection === "technical" ? "page" : undefined} className="nav-tab" style={{ marginRight: "10px", borderRadius: "6px 6px 0 0" }}>
//                 TECHNICAL INFORMATION
//               </button>
//               <button onClick={() => handleNavClick("gallery")} aria-current={activeSection === "gallery" ? "page" : undefined} className="nav-tab" style={{ borderRadius: "6px 6px 0 0" }}>
//                 GALLERY
//               </button>
//             </div>
//           </nav>
...
//           {/* PRODUCTS SECTION */}
//           <section ref={productSectionRef} id="product" style={{ scrollMarginTop: "80px" }} className="reveal-on-scroll">
//             <h2 style={sectionTitleStyle}>PRODUCTS</h2>
//             {renderModelStructureTable()}
//             <div style={enquireContainerStyle} className="enquire reveal-on-scroll">
//               <span style={enquireTextStyle}>Need customized light?</span>
//               <button onClick={() => navigate("/enquire", { state: { productName: slug } })} className="enquire-btn">
//                 Enquire Now
//               </button>
//             </div>
//             <div>
//               <h3 style={{ fontSize: "1.3rem", color: "#555555", textAlign: "center", fontWeight: 600, marginTop: "4rem", textTransform: "uppercase" }}>
//                 Dimensional Overview
//               </h3>
//               <div style={{ display: "flex", justifyContent: "center", margin: "2rem 0" }} className="reveal-on-scroll">
//                 <img src={dimensionImage} alt={`${product.title} dimension`} style={{ maxWidth: "800px", width: "100%", height: "auto", objectFit: "contain" }} loading="lazy" draggable={false} />
//               </div>
//             </div>
//           </section>
...
//           {/* GALLERY SECTION */}
//           <section ref={gallerySectionRef} id="gallery" style={{ scrollMarginTop: "80px" }} className="gallery-section reveal-on-scroll">
//             <h2 style={sectionTitleStyle3}>GALLERY</h2>
//             {!loadGallery ? (
//               <div style={{ height: 'var(--marquee-height)', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f0f0f0' }}>
//                 Loading Gallery...
...
//                   {galleryImages.map((imgSrc, i) => (
//                     <li key={i}>
//                       <img src={imgSrc} alt={`Gallery image ${i + 1}`} loading="lazy" draggable={false} onClick={() => handleImageClick(imgSrc)} />
//                     </li>
//                   ))}
//                 </ul>
//               </div>
...
//             <div style={modalStyle} onClick={handleCloseModal}>
//               <div style={modalContentStyle} onClick={(e) => e.stopPropagation()}>
//                 <div ref={zoomContainerRef} style={zoomContainerStyle} onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp} onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
//                   <img src={selectedImage} alt="Zoomed" style={zoomImageStyle(zoomLevel, position.x, position.y)} draggable={false} />
//                 </div>
//                 <div style={buttonContainerStyle}>
//                   <button style={controlButtonStyle} onClick={handleZoomIn} className="control-btn">+</button>
//                   <button style={controlButtonStyle} onClick={handleZoomOut} className="control-btn">−</button>
//                   <button style={closeButtonStyle} onClick={handleCloseModal} className="close-btn">
//                     <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2"><path d="M18 6L6 18M6 6l12 12"/></svg>
//                   </button>
//                 </div>
//               </div>
//             </div>
...
//             background: "linear-gradient(to top, #f8fafb 0%, transparent 70%)",
//             textAlign: "center",
//             marginTop: "3rem",
//           }}
//           className="reveal-on-scroll"
...
// import CommonSpecifications from "../components/product/CommonSpecifications";
// import StickyNav from "../components/product/StickyNav";
// import ModelTable from "../components/product/ModelTable";
// import TechnicalInfoTable from "../components/product/TechnicalInfoTable";
// import GalleryMarquee from "../components/product/GalleryMarquee";
// import ImageZoomModal from "../components/product/ImageZoomModal";

// import { productsData, galleryImagesMap, dimensionImages } from "../data/productsData";
...
//   useEffect(() => {
//     if (!loadGallery || !marqueeRef.current) return;

//     const root = document.documentElement;
//     const displayed = parseInt(getComputedStyle(root).getPropertyValue("--marquee-elements-displayed"));
//     const children = Array.from(marqueeRef.current.children);
//     const total = children.length;

//     root.style.setProperty("--marquee-elements", total);

//     // Clone items for infinite scroll
//     for (let i = 0; i < displayed; i++) {
//       marqueeRef.current.appendChild(children[i % total].cloneNode(true));
//     }

//     // Re-attach click events
//     marqueeRef.current.querySelectorAll("img").forEach((img, i) => {
//       img.onclick = () => setSelectedImage(galleryImages[i % galleryImages.length]);
//     });
...
//           <div className="desc-spec-grid">
//             <ProductDescription description={product.description.intro} />
//             <CommonSpecifications />
//           </div>

//           <StickyNav activeSection={activeSection} onNavClick={handleNavClick} />

//           {/* PRODUCTS SECTION */}
//           <section ref={productSectionRef} className="section">
//             <h2 className="section-title">PRODUCTS</h2>
//             <ModelTable product={product} slug={slug} navigate={navigate} />

//             <div className="enquire-box reveal-on-scroll">
//               <span>Need customized light?</span>
//               <button
//                 onClick={() => navigate("/enquire", { state: { productName: slug } })}
//                 className="enquire-btn"
//               >
...
//             <div className="dimension-image reveal-on-scroll">
//               <img
//                 src={dimensionImages[slug]}
//                 alt={`${product.title} dimensions`}
...
//           {/* TECHNICAL SECTION */}
//           <section ref={techInfoSectionRef} className="section">
//             <h2 className="section-title tech">TECHNICAL INFORMATION</h2>
//             <TechnicalInfoTable productTitle={product.title} />
//           </section>

//           <hr className="divider" />

//           {/* GALLERY SECTION */}
//           <section ref={gallerySectionRef} className="section gallery-section">
...
//   useEffect(() => {
//     // Scroll event for "Go Top" button visibility
//     const handleScroll = () => {
//       const gotop = document.getElementById("gotop");
//       if (!gotop) return;
//       const windowHeight = window.innerHeight;
...
//         <h1 className="product-title reveal-on-scroll">{product.title}</h1>
...
//           </div>
//           <CommonSpec commonSpecs={{ ...COMMON_SPECIFICATIONS, Geometry: product.title }} />
//         </div>
//         <nav
//           id="navbar"
//           aria-label="Product details navigation"
...
//           aria-label="Technical Information"
//         >
//           <h2 className="section-title-2">TECHNICAL INFORMATION</h2>
...
//   aria-label="Gallery"
// >
//   <h2 className="section-title-3">GALLERY</h2>
