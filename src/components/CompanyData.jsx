...
const statsConfig = [
  {
    ...
    value: 70,
    suffix: "+",
    labelKey: "CompanyData.stat1Label",
    icon: (
  ...
  },
  {
    ...
    value: 100,
    suffix: "%",
    labelKey: "CompanyData.stat2Label",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    value: 17,
    suffix: "",
    labelKey: "CompanyData.stat3Label",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    value: 1000,
    suffix: "+",
    labelKey: "CompanyData.stat4Label",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function StatCard({ stat, inView }) {
  ...
  return (
    ...
    >
      ...
      {/* Icon — no inline color, CSS handles white → red on hover */}
      ...
      <div className="cd-number">
        ...
        <span className="cd-suffix">{stat.suffix}</span>
      </div>

      {/* Label */}
      <div className="cd-label">{t(stat.labelKey)}</div>
      ...
      <div className="cd-inner">
        <div className={`cd-header ${inView ? "cd-header--visible" : ""}`}>
          <div className="cd-eyebrow">
            ...
            <span className="cd-eyebrow-text">{t("CompanyData.eyebrow")}</span>
            <span className="cd-eyebrow-line" />
          </div>
          <h2 className="cd-title">
            {t("CompanyData.title")}{" "}
            <span className="cd-title-accent">{t("CompanyData.titleAccent")}</span>
          </h2>
          <p className="cd-subtitle">{t("CompanyData.subtitle")}</p>
        </div>
