...
// import BagSealImg from "../assets/CaseStudies/bag_seal.png";
// import AndroidBarcodeImg from "../assets/CaseStudies/Android_Barcode.png";
// import "../Styles/CaseStudy.css";
...
//   { id: 11, imgSrc: LadleHookImg },
//   { id: 12, imgSrc: CylinderHeadImg },
//   { id: 13, imgSrc: BagSealImg },        // placeholder — replace with real image when available
//   { id: 14, imgSrc: AndroidBarcodeImg }, // placeholder — replace with real image when available
// ];
...
// //                 onClick={() => handleImageClick(index, study.id)}
// //               >
// //                 <div className="card-header">{study.id}. {t(`CaseStudies.${study.id}.studyHeader`)}</div>
// //                 <img src={study.imgSrc} alt={t(`CaseStudies.${study.id}.title`)} />
// //                 <div className="overlay">
// //                   <motion.div
// //                     className="icon-animation"
