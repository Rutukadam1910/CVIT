...
// import BagSealImg from "../assets/CaseStudies/bag_seal_3.png";
// import AndroidBarcodeImg from "../assets/CaseStudies/Android_Barcode_3.png";
// import "../Styles/CaseStudyDetail.css";
// import Navbar from "./Navbar";
// import SideBar from "./Sidebar";
// import Footer from "./Footer";
...
//   11: LadleHookImg,
//   12: CylinderHeadImg,
//   13: BagSealImg,        // placeholder — replace with real image when available
//   14: AndroidBarcodeImg, // placeholder — replace with real image when available
// };
...
//   { id: 11, title: "Ladle Hook Inspection" },
//   { id: 12, title: "360° Cylinder Head Inspection" },
//   { id: 13, title: "Bag Seal Wrinkle Inspection" },
//   { id: 14, title: "Android Barcode Scanning & Part Verification" },
// ];
...
//     title: t(`CaseStudies.${id}.title`),
//     studyHeader: t(`CaseStudies.${id}.studyHeader`),
//     image: caseStudyImages[parseInt(id, 10)],
//     description: t(`CaseStudies.${id}.description`),
//   }), [id, t]);
...
//   const validIds = caseStudiesFallback.map((cs) => cs.id);
//   const isValidId = validIds.includes(parseInt(id, 10));

//   if (!isReady) {
//     return null; // Wait for i18next to finish loading
//   }

//   if (!isValidId || !study.title || study.title.includes("CaseStudies") || !study.description) {
//     return (
//       <div className="cs-notfound" style={notFoundStyles.wrapper}>
//         <h2 style={notFoundStyles.title}>{t("PageNotFound")}</h2>
//         <button
...
//           <div className="hero-content-pro">
//             <p className="eyebrow">{t("CaseStudies.CaseStudy")}</p>
//             <h1 className="hero-headline">{study.studyHeader}</h1>
//             <p className="hero-subhead">{study.title}</p>
//             <div className="hero-cta">
//               <button
//                 className="btn-primary-pro"
...
// // // //         <div className="hero-container">
// // // //           <div className="hero-content-pro">
// // // //             <p className="eyebrow">{t("CaseStudies.CaseStudy")} {study.id}</p>
// // // //             <h1 className="hero-headline">
// // // //               {study.studyHeader}
// // // //             </h1>
// // // //             <p className="hero-subhead">{study.title}</p>
